...
public interface RoomRepository extends JpaRepository<Room, Long> {
    ...
    @Query(nativeQuery = true, value = """
            WITH agg_room_res AS (SELECT r.id,
                 ...
                 res AS (SELECT r.id,
                         ...
                         WHERE ((:roomTypes) IS NULL
                           ...
                           AND (:numberOfGuests IS NULL OR total_capacity >= :numberOfGuests)
                           AND (:numberOfRequestedNights IS NULL OR minimum_nights <= :numberOfRequestedNights)
            ...
            """, countQuery = """
                            ...
                            FROM res
            """)
    Page<RoomView> getRoomAggregated(@Param("checkInDate") LocalDate checkInDate,
